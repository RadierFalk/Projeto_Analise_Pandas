...
# O mapa de calor mostra a correlação entre as matérias-primas maior o valor
#correlacionado maior chance de serem duas matérias-primas relacionadas, mas não
#necessáriamente
